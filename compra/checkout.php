...
<body>
   ...
   <input type="checkbox" id="menu-toggle">
    ...
    $user_id = $_SESSION['id'];
      $cart_grand_total = 0;
      $select_cart_items = $connect->prepare("SELECT carrito_compras.idcpr, carrito_compras.user_id, productos.precio,productos.stock,productos.foto,productos.idprod, productos.codpro, productos.nomprd, carrito_compras.name, carrito_compras.price, carrito_compras.quantity FROM carrito_compras INNER JOIN productos ON carrito_compras.idprod = productos.idprod WHERE user_id = ?");
