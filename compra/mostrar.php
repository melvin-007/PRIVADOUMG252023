...
$sentencia = $connect->prepare("SELECT pedidos_compras.idordpur, pedidos_compras.user_id, proveedores.idprov, proveedores.rucprv, proveedores.nomprv, pedidos_compras.total_products, pedidos_compras.total_price, pedidos_compras.placed_on, pedidos_compras.payment_status, pedidos_compras.tipc FROM pedidos_compras INNER JOIN proveedores ON pedidos_compras.idprov = proveedores.idprov ORDER BY idordpur DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
