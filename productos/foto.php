...
if($sentencia){
  ...
  <div class="containerss">  
    <h1>Actualizar imagen del Robot</h1>
    <div class="alert-danger">
  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
  <strong>Importante!</strong> NO DEJAR CAMPOS VACIOS &nbsp;<span class="badge-warning">*</span>
</div>
    <hr>
    <br>

  
    <label for="email"><b>Foto del Robot</b></label><span class="badge-warning">*</span>
    <div class="upload-box">
        <div class="upload-img">
            <img src="../../backend/img/subidas/<?php echo $d->foto; ?>" alt="">     
        </div>
        <div class="page-header">
                <h1>CODIGO DE ROBOT: <?php echo $d->codpro; ?></h1>       
        </div>
        <div class="page-header">
                <h1>NOMBRE DEL ROBOT: <?php echo $d->nomprd; ?></h1>       
        </div>
        <div class="page-header">
                <h1>DESCRIPCION DEL ROBOT: <?php echo $d->desprd; ?></h1>       
        </div>
        <div class="page-header">
                <h1>PRECIO DEL ROBOT: <?php echo $d->precio; ?></h1>       
        </div>
        <div class="page-header">
                <h1>STOCK DEL ROBOT: <?php echo $d->stock; ?></h1>       
        </div>
        <div class="page-header">
                <h1>PESO DEL ROBOT: <?php echo $d->peso; ?></h1>       
        </div>
        <div class="page-header">
            </div>
